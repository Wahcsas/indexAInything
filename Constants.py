...
class Constants:
    ...
    Return ALL person names (first names, last names) from the text. If a first or last name part 
    ...
    Return all names as json in the following list json format. 
    If there are multiple names within the text, return a list of jsons, like this: 
    ...
    EXAMLES_USER = [
        "So if one asks is there anything faster than light. The answer is: No!, as shown by Albert Einstein and Paul Hawking",
    ...
    EXAMPLES_ASSISTANT = ['[{"First Name": "Albert", "Last Name": "Einstein"}, {"First Name": "Paul", "Last Name": "Hawking"}]',
