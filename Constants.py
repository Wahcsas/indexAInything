...
class Constants:
    ...
    MODEL_NAME = 'llama3.2:latest'  # 'mistral:7b'
    EXTRACT_COLUMN_KEYS = ["First Name", "Last Name"]
    SYSTEM_PROMPT = """You are an expert in extracting persons names from texts.
    Analyse the provided texts carefully and check if there is any name of a PERSON, first name or last name, in it.
    ...
    EXAMLES_USER = [
        ...
        "In the field of political science, the analysis of electoral behavior and party dynamics often highlights significant regional and cultural variations. In Germany, the Christian Democratic Union (CDU), lead by Hans Günther Mayer, has historically maintained strongholds in regions such as Bavaria and Baden-Württemberg, while urban centers like Berlin and Hamburg have shown greater support for parties like the Social Democratic Party (SPD) and The Greens."]
